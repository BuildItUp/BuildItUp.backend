...
<div class="worker-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-worker-search-user_id']
            ],
        [
                'attribute' => 'city_id',
                'label' => 'City',
                ...
                'filterInputOptions' => ['placeholder' => 'Cities', 'id' => 'grid-worker-search-city_id']
            ],
        [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\common\models\Specialization::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Specialization', 'id' => 'grid-worker-search-specialization_id']
            ],
        'fullname',
        'citizen_id',
        'birthdate',
