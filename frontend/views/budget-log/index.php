...
<div class="budget-log-index">
    ...
    <p>
        <?= Html::a('Create Budget Log', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Worker', 'id' => 'grid-budget-log-search-worker_id']
            ],
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Customer', 'id' => 'grid-budget-log-search-customer_id']
            ],
        'date',
        'action',
        'amount',
